...
setup(
    ...
    description="REGIS-7B-C: 220MB encrypted language model with voice synthesis",
    ...
    extras_require={
        "gpu": ["torch>=2.0.0"],
        "audio": ["sounddevice>=0.4.6", "soundfile>=0.12.1"],
